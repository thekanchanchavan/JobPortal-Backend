...
public interface UserService {
    public ResponseEntity<ApiResponse> authenticatedUser(User user)throws Exception;
    public ResponseEntity<String> changePassword(String username, String oldPassword,
